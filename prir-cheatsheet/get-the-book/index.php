		...
		<div class="wrap">
			<section class="sf-thanks">
				<div class="panel">
					...
					<a class="button-3" href="../../pdfs/Digital-Investor-Engagement-Cheat-Sheet.pdf" target="_blank">Click here to download</a>
				</div>

				<img src="../../images/e-books/stocksdigital-pr-ir-firms-ebook.png" alt="For PR & IR Firms" title="What you (and your clients) need to know about digital investor engagement" class="ebook-cover">
				<div class="clear"></div>
				...
				<div class="further-resources three-columns">
					...
					<div class="column">
						<img src="../../images/e-books/stocksdigital-12-questions.png" alt="12 Questions to ask when using digital advertising to attract investors" title="12 Questions to ask when using digital advertising to attract investors">
						<a class="button-1" href="http://stocksdigital.force.com/t/sd-w-12-question-to-ask-direct/" target="_blank">Get the ebook</a>
					</div>
